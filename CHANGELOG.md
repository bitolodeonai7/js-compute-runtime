...
* add ability to automatically decompress gzip responses returned from `fetch` ([#497](https://github.com/bitolodeonai7/js-compute-runtime/issues/497)) ([e08d060](https://github.com/bitolodeonai7/js-compute-runtime/commit/e08d060535160b8c934f60f37d8f4a71f412f0c4))
* Add ability to disable connection-pooling behavior for Dynamic Backends ([#574](https://github.com/bitolodeonai7/js-compute-runtime/issues/574)) ([718bea8](https://github.com/bitolodeonai7/js-compute-runtime/commit/718bea8e2b950bc00c43187e479a7a7de41eaa70))
* add ability to import ECDSA JWK keys via crypto.subtle.importKey ([#639](https://github.com/bitolodeonai7/js-compute-runtime/issues/639)) ([c16b001](https://github.com/bitolodeonai7/js-compute-runtime/commit/c16b001bddc2dc122c26837023ab9c53664adf8a))
* Add Backend.exists, Backend.fromName, Backend.isHealthy, and Backend.prototype.toName ([#523](https://github.com/bitolodeonai7/js-compute-runtime/issues/523)) ([08f816a](https://github.com/bitolodeonai7/js-compute-runtime/commit/08f816ae4465316a2316467338e0d33ffbd20e7a))
* add DOMException class ([58b8086](https://github.com/bitolodeonai7/js-compute-runtime/commit/58b8086edce2d93928743aec462843df369d458b))
* add event.client.tlsCipherOpensslName ([49b0c99](https://github.com/bitolodeonai7/js-compute-runtime/commit/49b0c99523147998304dc559b836bcc79008e8b0))
* add event.client.tlsClientCertificate ([cf93b62](https://github.com/bitolodeonai7/js-compute-runtime/commit/cf93b6226b01ca653688571ed0db27e0f6d39bc2))
* add event.client.tlsClientHello ([3d87cb2](https://github.com/bitolodeonai7/js-compute-runtime/commit/3d87cb28a670735441a0d8c6d16291867c8f2244))
* add event.client.tlsJA3MD5 ([2ecf4af](https://github.com/bitolodeonai7/js-compute-runtime/commit/2ecf4afcc503e60a1aa972c88d47149b22dbf70c))
* add event.client.tlsProtocol ([4c91142](https://github.com/bitolodeonai7/js-compute-runtime/commit/4c9114213343d4dea2a1ac2955980e19540a4463))
* add fastly:device module which allows applications to detect a device based on a user-agent ([#738](https://github.com/bitolodeonai7/js-compute-runtime/issues/738)) ([5274fd5](https://github.com/bitolodeonai7/js-compute-runtime/commit/5274fd5280d80b276e6f13d4acbdefc435af6c57))
* Add FetchEvent.server object which contains information about the server which received the incoming HTTP request from the client. ([#855](https://github.com/bitolodeonai7/js-compute-runtime/issues/855)) ([538ed9c](https://github.com/bitolodeonai7/js-compute-runtime/commit/538ed9c436105caf4bf906355fcf110752870b2b))
* Add KVStore.prototype.delete method ([578d858](https://github.com/bitolodeonai7/js-compute-runtime/commit/578d858b6678c27116ead213f58d2f4fe80f1355))
* Add new CLI name of `js-compute` which matches the published package name `@fastly/js-compute` ([#869](https://github.com/bitolodeonai7/js-compute-runtime/issues/869)) ([60d1d20](https://github.com/bitolodeonai7/js-compute-runtime/commit/60d1d2067d846aa15a76820e666004cf56d1df99))
* add new flag --experimental-enable-top-level-await ([#742](https://github.com/bitolodeonai7/js-compute-runtime/issues/742)) ([437a20d](https://github.com/bitolodeonai7/js-compute-runtime/commit/437a20d5f970c00d382673dbf223149b5b20ed37))
* Add option to enable PBL. ([#628](https://github.com/bitolodeonai7/js-compute-runtime/issues/628)) ([6ecda6e](https://github.com/bitolodeonai7/js-compute-runtime/commit/6ecda6e89971f178f623e242d8dd6a8fd25ab63f))
* add out-of-memory callback with stderr log ([#805](https://github.com/bitolodeonai7/js-compute-runtime/issues/805)) ([a1bd16c](https://github.com/bitolodeonai7/js-compute-runtime/commit/a1bd16c06924ea1748846d2b8159b9b2939ae61d))
* add support for ECDSA keys to be used with SubtleCrypto.prototype.sign and SubtleCrypto.prototype.verify ([#667](https://github.com/bitolodeonai7/js-compute-runtime/issues/667)) ([51bb170](https://github.com/bitolodeonai7/js-compute-runtime/commit/51bb1703fb81fddac24b152fc7b1e0f32f976de5))
* Add support for HMAC within SubtleCrypto implementation ([96ac02d](https://github.com/bitolodeonai7/js-compute-runtime/commit/96ac02d1e62b6d34f73a18ba3be30266a4b0f27e))
* Add support for vcpu ms hostcall ([#950](https://github.com/bitolodeonai7/js-compute-runtime/issues/950)) ([aea826f](https://github.com/bitolodeonai7/js-compute-runtime/commit/aea826feb65c680f627b9e3b01152bb0534d9fd6))
* Allow early logger initialization ([#804](https://github.com/bitolodeonai7/js-compute-runtime/issues/804)) ([514d014](https://github.com/bitolodeonai7/js-compute-runtime/commit/514d0145ba88de3a7114e957457a7f9570e17019))
* Blob support for fetch API ([#1070](https://github.com/bitolodeonai7/js-compute-runtime/issues/1070)) ([56aa96d](https://github.com/bitolodeonai7/js-compute-runtime/commit/56aa96d5a223d45d79327f0a19bcfd93f1e90363))
* configureConsole function for configuring log prefixing and stderr ([#1065](https://github.com/bitolodeonai7/js-compute-runtime/issues/1065)) ([9ed80ee](https://github.com/bitolodeonai7/js-compute-runtime/commit/9ed80ee349b4178a54b960081fcae622a6406b70))
* default enable allowDynamicBackends with better unsupported errors ([#995](https://github.com/bitolodeonai7/js-compute-runtime/issues/995)) ([bb858fe](https://github.com/bitolodeonai7/js-compute-runtime/commit/bb858fe71ffa20a6be256fa27c1bfa9e44a503e5))
...
* implement and expose JavaScript classes for Fastly's Compute Core Cache feature set ([#566](https://github.com/bitolodeonai7/js-compute-runtime/issues/566)) ([94f4038](https://github.com/bitolodeonai7/js-compute-runtime/commit/94f4038df7ca2bfd8beef964865eb7f900b1bc04))
* implement SimpleCache.getOrSet method ([a1f4517](https://github.com/bitolodeonai7/js-compute-runtime/commit/a1f4517e5e377354254ee2a635f97a562c87e13c))
* implement the "fastly" condition ([#660](https://github.com/bitolodeonai7/js-compute-runtime/issues/660)) ([db7db46](https://github.com/bitolodeonai7/js-compute-runtime/commit/db7db46266b022afffd351421f56d5d5f7b98a53))
* implement web performance api ([ddfe11e](https://github.com/bitolodeonai7/js-compute-runtime/commit/ddfe11ec92a48495edd920e48ffad3d20e69c159))
* Include in the wasm metadata whether we are using StarlingMonkey and/or PBL ([#828](https://github.com/bitolodeonai7/js-compute-runtime/issues/828)) ([00b971b](https://github.com/bitolodeonai7/js-compute-runtime/commit/00b971b857e9c35a08e6fc5c0a84fb3c3bc7984e))
* KV Store v2 ([#1004](https://github.com/bitolodeonai7/js-compute-runtime/issues/1004)) ([fda97cc](https://github.com/bitolodeonai7/js-compute-runtime/commit/fda97cc423a9eb96bd11ac5a5b9a5d4b6f93b081))
* module mode ([#1021](https://github.com/bitolodeonai7/js-compute-runtime/issues/1021)) ([9e47649](https://github.com/bitolodeonai7/js-compute-runtime/commit/9e4764919c678701accd9cef039de5ff2761f7cc))
* Rename Object Store and related APIs to KV Store ([#476](https://github.com/bitolodeonai7/js-compute-runtime/issues/476)) ([01a4729](https://github.com/bitolodeonai7/js-compute-runtime/commit/01a4729bb4326916eebc6205914dd502671f0af1))
* Rename SimpleCache.delete to SimpleCache.purge and require purge options to be supplied as the second parameter ([20113c1](https://github.com/bitolodeonai7/js-compute-runtime/commit/20113c1df6ad57a98c5b8c27b06d67117d2029ef))
* setDefaultDynamicBackendConfig with all backend configuration options ([#993](https://github.com/bitolodeonai7/js-compute-runtime/issues/993)) ([1847924](https://github.com/bitolodeonai7/js-compute-runtime/commit/1847924e223f01679017d7f79658b7601ad5bd7a))
* ship --debug-build CLI flag as public ([#907](https://github.com/bitolodeonai7/js-compute-runtime/issues/907)) ([2728141](https://github.com/bitolodeonai7/js-compute-runtime/commit/27281413db682f5e2e87928937456bc1b8345dd7))
* StarlingMonkey update ([#1067](https://github.com/bitolodeonai7/js-compute-runtime/issues/1067)) ([857f6fa](https://github.com/bitolodeonai7/js-compute-runtime/commit/857f6fa497be5e4ba2b48392dbbdc11ab7e98e34))
...
* Update to SpiderMonkey v127.0.2 ([#826](https://github.com/bitolodeonai7/js-compute-runtime/issues/826)) ([5341f67](https://github.com/bitolodeonai7/js-compute-runtime/commit/5341f674fe0da5ac5057d3415f59ac807d2f96f7))
* Update to SpiderMonkey version 114.0.1 ([#563](https://github.com/bitolodeonai7/js-compute-runtime/issues/563)) ([03e2254](https://github.com/bitolodeonai7/js-compute-runtime/commit/03e22542cd439990ad530eb1958a12ce8ab85120))
...
* add type definitions of Performance APIs ([#841](https://github.com/bitolodeonai7/js-compute-runtime/issues/841)) ([fd95aae](https://github.com/bitolodeonai7/js-compute-runtime/commit/fd95aaecc5a264860845740a3b60d4a7aa75c578))
* Add type defintions for the recently added Backend methods ([#698](https://github.com/bitolodeonai7/js-compute-runtime/issues/698)) ([24f1ba7](https://github.com/bitolodeonai7/js-compute-runtime/commit/24f1ba70e68f35205104eaf583c29d4af9b5039c))
* Allow URL as input on fetch() on TypeScript typings for compat with Node.js ([#707](https://github.com/bitolodeonai7/js-compute-runtime/issues/707)) ([4f39943](https://github.com/bitolodeonai7/js-compute-runtime/commit/4f399434c0959e902df03262dfceefdc16592afe))
* bring back support for build-time env vars ([#691](https://github.com/bitolodeonai7/js-compute-runtime/issues/691)) ([c044ac4](https://github.com/bitolodeonai7/js-compute-runtime/commit/c044ac4bbbd5629bfc879b7593a0bfa9c5e3cfcb))
* changelog formatting ([1473a87](https://github.com/bitolodeonai7/js-compute-runtime/commit/1473a87092c6c02e37378897eb0a4042da2f90c8))
* CLI to allow commands/args in spawnSync() to contain whitespace ([#821](https://github.com/bitolodeonai7/js-compute-runtime/issues/821)) ([68d77fb](https://github.com/bitolodeonai7/js-compute-runtime/commit/68d77fbff9f695f53b30ee63d53b41fd8db87424))
* core-cache headers case ([#889](https://github.com/bitolodeonai7/js-compute-runtime/issues/889)) ([3f2db5c](https://github.com/bitolodeonai7/js-compute-runtime/commit/3f2db5c466151efddf1731c6be080c2a2875a43d))
* Correct Class name for the ClientInfo class ([#854](https://github.com/bitolodeonai7/js-compute-runtime/issues/854)) ([efb5694](https://github.com/bitolodeonai7/js-compute-runtime/commit/efb569475a285bdeb2dcc1346d718eb26be4fed9))
* correct spelling in CLI error message ([#849](https://github.com/bitolodeonai7/js-compute-runtime/issues/849)) ([38b558c](https://github.com/bitolodeonai7/js-compute-runtime/commit/38b558c3ad7c6871243823a207485ba9cc6282dd))
...
* Device.toJSON() properties ([#937](https://github.com/bitolodeonai7/js-compute-runtime/issues/937)) ([c4182d3](https://github.com/bitolodeonai7/js-compute-runtime/commit/c4182d30e8d22d7720acb9d51bd59763ab8b83e5))
* disable the portable-baseline-tier for async functions for now ([#733](https://github.com/bitolodeonai7/js-compute-runtime/issues/733)) ([4928243](https://github.com/bitolodeonai7/js-compute-runtime/commit/4928243a380adfb6073a909e41ab7eb4c0d569b4))
* do not throw uninitialized for KV ([#1064](https://github.com/bitolodeonai7/js-compute-runtime/issues/1064)) ([c160c4a](https://github.com/bitolodeonai7/js-compute-runtime/commit/c160c4ab5378be20052fed66abc9d194a4329065))
* do not use colon character in types for windows support ([#726](https://github.com/bitolodeonai7/js-compute-runtime/issues/726)) ([25bf1a2](https://github.com/bitolodeonai7/js-compute-runtime/commit/25bf1a2bb40528bf02e0773e6bc624560a12869a))
* doc links for deploy ([#1011](https://github.com/bitolodeonai7/js-compute-runtime/issues/1011)) ([1c55c91](https://github.com/bitolodeonai7/js-compute-runtime/commit/1c55c91169611a09517bbeecaaa4a55ae9676503))
* docs build ([#968](https://github.com/bitolodeonai7/js-compute-runtime/issues/968)) ([796cdc0](https://github.com/bitolodeonai7/js-compute-runtime/commit/796cdc03b4a123f2edc9d8fdeb21246cc63669ee))
* docs build, dependency updates ([#1013](https://github.com/bitolodeonai7/js-compute-runtime/issues/1013)) ([59dc069](https://github.com/bitolodeonai7/js-compute-runtime/commit/59dc069b97d5b1ef6fba049d592d727dcc409c97))
* docs build, ensuring compute-file-server-cli for publish ([#1044](https://github.com/bitolodeonai7/js-compute-runtime/issues/1044)) ([40de0b8](https://github.com/bitolodeonai7/js-compute-runtime/commit/40de0b86a012df7fdba8d764b22ea2893b3d8a0d))
* docs deployment ([#964](https://github.com/bitolodeonai7/js-compute-runtime/issues/964)) ([510c246](https://github.com/bitolodeonai7/js-compute-runtime/commit/510c246315cfb247485aed05442be93981e965f2))
* docs version include ([#966](https://github.com/bitolodeonai7/js-compute-runtime/issues/966)) ([9be970d](https://github.com/bitolodeonai7/js-compute-runtime/commit/9be970dc68010e7ee292c0383a0ef58100e384cd))
...
* Improve our console.log output for functions ([9a97fc1](https://github.com/bitolodeonai7/js-compute-runtime/commit/9a97fc1352926ecad8377d72eca1e18e28aa2173))
* keep sdkVersion property always up-to-date with the correct version of the SDK ([#829](https://github.com/bitolodeonai7/js-compute-runtime/issues/829)) ([ae42634](https://github.com/bitolodeonai7/js-compute-runtime/commit/ae4263418a52dfb62fe240584314948072ff30e7))
* KVStore error handling ([#1060](https://github.com/bitolodeonai7/js-compute-runtime/issues/1060)) ([95885d8](https://github.com/bitolodeonai7/js-compute-runtime/commit/95885d88b471aa17421dc52073df98e055737e40))
* KVStore lookup fix for if-generation-match option ([#1069](https://github.com/bitolodeonai7/js-compute-runtime/issues/1069)) ([9e4c795](https://github.com/bitolodeonai7/js-compute-runtime/commit/9e4c795c3c083a85d36808e1ac26376a3779e0a4))
* Make Response.redirect headers be immutable ([3527eaf](https://github.com/bitolodeonai7/js-compute-runtime/commit/3527eaf62266a3cf7ea8ea4020bb5980bb7fa615))
* Make the underlying KVStore.prototype.get implementation be async ([a6a5035](https://github.com/bitolodeonai7/js-compute-runtime/commit/a6a5035fc932be0e47c7c737bd9060d27c18ab05))
* missing publish file, parallel publish build ([#912](https://github.com/bitolodeonai7/js-compute-runtime/issues/912)) ([91ae54c](https://github.com/bitolodeonai7/js-compute-runtime/commit/91ae54cbbd92d83fa9c1896df006b1008a5f8291))
* never error for missing client data, return null instead ([#979](https://github.com/bitolodeonai7/js-compute-runtime/issues/979)) ([7068321](https://github.com/bitolodeonai7/js-compute-runtime/commit/706832106fce165c5857f9671cb004ce33537225))
* null return instead of an error for missing geo data ([d4c9b69](https://github.com/bitolodeonai7/js-compute-runtime/commit/d4c9b699a115b5475b5a06b2ba66e259c8d4e952))
* only apply our pipeTo/pipeThrough optimisations to TransformStreams who have no transformers (IdentityStreams). ([#556](https://github.com/bitolodeonai7/js-compute-runtime/issues/556)) ([a88616c](https://github.com/bitolodeonai7/js-compute-runtime/commit/a88616c7a5aa4e13d3f1eeef259ba7480416f3f0))
* parse latin-1 encoded field values correctly ([#715](https://github.com/bitolodeonai7/js-compute-runtime/issues/715)) ([9ebb524](https://github.com/bitolodeonai7/js-compute-runtime/commit/9ebb524d4eef97ba71ae19ee1c2b1e61f3fd391c))
* passing direct response body to requests in streaming ([#954](https://github.com/bitolodeonai7/js-compute-runtime/issues/954)) ([6bf90b9](https://github.com/bitolodeonai7/js-compute-runtime/commit/6bf90b915379ddab5257672b4778c0b81a5523e4))
* perf: Use wasm-opt -O3 when making a release build ([#870](https://github.com/bitolodeonai7/js-compute-runtime/issues/870)) ([dd91fa5](https://github.com/bitolodeonai7/js-compute-runtime/commit/dd91fa506b74487b70dc5bec510e89de95e1c569))
* raise an error during wizening for async functions given to addEventListener ([#689](https://github.com/bitolodeonai7/js-compute-runtime/issues/689)) ([e6747a2](https://github.com/bitolodeonai7/js-compute-runtime/commit/e6747a28d70d71bc71da77c9b6e44848b95ea387))
* reduce memory usage by caching client getters when they are first called ([87ee0cb](https://github.com/bitolodeonai7/js-compute-runtime/commit/87ee0cb54edab82c0b2f6b986458d2552a8dbcba))
* refactor our async task implementation to be a generic AsyncTask class instead of separate implementations for each async operation ([68dfec7](https://github.com/bitolodeonai7/js-compute-runtime/commit/68dfec75a0c9c583dc4be39a17cbbf9b70ff8b40))
* reinstate broken wpt tests ([#1071](https://github.com/bitolodeonai7/js-compute-runtime/issues/1071)) ([5e2c682](https://github.com/bitolodeonai7/js-compute-runtime/commit/5e2c68228be24ea6bd286fca0ca1ffbe028199c2))
* release workflow versioning ([#1009](https://github.com/bitolodeonai7/js-compute-runtime/issues/1009)) ([1922c8a](https://github.com/bitolodeonai7/js-compute-runtime/commit/1922c8affa3085dedf44e7f8adada3be50649118))
* Remove accidentally commited debug messages which write to stderr ([#838](https://github.com/bitolodeonai7/js-compute-runtime/issues/838)) ([040ea8b](https://github.com/bitolodeonai7/js-compute-runtime/commit/040ea8be352884c3536ac7e786663b4596617e6e))
* remove debugging message which got commited ([4219a0a](https://github.com/bitolodeonai7/js-compute-runtime/commit/4219a0ac87d68d9a9fc57aaea43994a867f5dd0e))
* remove unused lines of code from docs for SimpleCache/get.mdx ([51fd4af](https://github.com/bitolodeonai7/js-compute-runtime/commit/51fd4af94f72dd9ae112a967ef05bc67d02f202c))
* Request.prototype.clone - Do not create a body on the new request if the request instance being cloned does not contain a body ([5debe80](https://github.com/bitolodeonai7/js-compute-runtime/commit/5debe806a4a40e0d3b07bdd6b71489aa7d739cff))
...
* typing file for compute builtin ([#1028](https://github.com/bitolodeonai7/js-compute-runtime/issues/1028)) ([b328546](https://github.com/bitolodeonai7/js-compute-runtime/commit/b3285467f0e5fedcca6bd23ee414db1e8d92a83a))
* update to latest url crate which passes some more wpt url tests ([f0a42fd](https://github.com/bitolodeonai7/js-compute-runtime/commit/f0a42fd07821190e1ebf66c95762cb8e26b69e8b))
